...
def main():
    ...
    CLASSIFICATION_CSV_PATH = './results/classification_log.csv'
...
def process_window_classification(window_config, data, forecast_horizon, hyperparams):
    ...
    train_data_transformed, test_data_transformed, _ = apply_log_transformation(train_data, test_data)

    return optimize_and_train_classification(train_data_transformed, test_data_transformed, forecast_horizon,
