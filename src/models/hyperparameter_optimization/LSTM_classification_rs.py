...
def main():
    ...
    for window in windows:
        ...
        for horizon in FORECAST_HORIZONS_CLF:
            print(f"\n--- Random Search for forecast horizon {horizon} on validation split ---")
            best_hyperparams, best_threshold, best_val_result = random_search_classification(
...
# ==============================================================================
# Random Search for Hyperparameters on Validation Split
# ==============================================================================
def random_search_classification(window_config, data, forecast_horizon, search_space, time_limit=600):
    best_result = None
